...
export default class Messages {
    ...
    private changeMapCallback?: ChangeMapPacketCallback;
    ...
    public constructor(private app: App) {
        ...
        this.messages[Packets.ChangeMap] = () => this.changeMapCallback;
    ...
    public onChangeMap(callback: ChangeMapPacketCallback): void {
