...
export default class World {
    public maps: MapManager;
    /** Default map; kept for backward compatibility with single-map code paths. */
    public map: Map;
    public api: API;
    ...
    private tick(): void {
        setInterval(() => {
            ...
            for (let map of this.maps.getAll()) map.regions.parse();
        }, config.updateTime);
